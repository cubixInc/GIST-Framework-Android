...
public class BaseTextClock extends TextClock {

    private SyncResourceManager syncResourceManager;

    public BaseTextClock(Context context) {
       super(context);
    }

    public BaseTextClock(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseTextClock(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public BaseTextClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);
