...
public class BaseSwitchCompat extends SwitchCompat {
    ...
    @TargetApi(21)
    @SuppressLint("NewApi")
    public BaseSwitchCompat(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                String switchTextPadding = mTypedArray.getString(R.styleable.baseView_cbx_switchTextPadding);
                ...
                setSwitchPadding(getContext(), switchTextPadding);
    ...
    public void setSwitchPadding(Context context, String switchPadding) {

        if (switchPadding != null && !switchPadding.isEmpty()) {

            switchPadding = switchPadding.replace("dp", "");
            int padding = GistUtils.dpToPx(context, Integer.parseInt(switchPadding));
            setSwitchPadding(padding);
        }
    }
