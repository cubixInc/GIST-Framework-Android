 ...
 */
public class BaseMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView {
    ...
    public BaseMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public BaseMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                int thresholdCount = mTypedArray.getInt(R.styleable.baseView_cbx_thresholdCount, getThreshold());
                ...
                setBaseThreshold(thresholdCount);
    ...
    public void setBaseThreshold(int thresholdCount) {

        setThreshold(thresholdCount);
    }
